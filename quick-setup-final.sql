-- Quick setup for essential tables - FINAL CORRECTED VERSION
...
VALUES 
    ('aaaaaaaa-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'payment', 25000.00, 'Payment received for business cards printing', 25000.00, '2024-12-15'),
    ('aaaaaaaa-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', 'payment', 45000.00, 'Payment for brochure printing project', 45000.00, '2024-12-16'),
    ('aaaaaaaa-3333-3333-3333-333333333333', '77777777-7777-7777-7777-777777777777', 'payment', 75000.00, 'Payment for catalog printing', 75000.00, '2024-12-17'),
    ('aaaaaaaa-4444-4444-4444-444444444444', '22222222-2222-2222-2222-222222222222', 'payment', 18000.00, 'Additional payment for letterhead', 43000.00, '2024-12-20'),
    ('aaaaaaaa-5555-5555-5555-555555555555', '33333333-3333-3333-3333-333333333333', 'payment', 28000.00, 'Payment for invoice printing', 73000.00, '2024-12-21')
ON CONFLICT (id) DO NOTHING;

-- Insert sample job sheets with valid UUIDs
...
VALUES 
    ('bbbbbbbb-1111-1111-1111-111111111111', 'GO24001', 'Business Cards for ABC Enterprises', 'Premium business cards with UV coating', '22222222-2222-2222-2222-222222222222', 1000, 25000.00, 'in_progress', 3, '11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', '66666666-6666-6666-6666-666666666666'),
    ('bbbbbbbb-2222-2222-2222-222222222222', 'GO24002', 'Company Brochures', 'Tri-fold brochures for XYZ Pvt Ltd', '33333333-3333-3333-3333-333333333333', 500, 45000.00, 'pending', 2, '11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', '55555555-5555-5555-5555-555555555555'),
    ('bbbbbbbb-3333-3333-3333-333333333333', 'GO24003', 'Product Catalog', 'Full-color product catalog printing', '77777777-7777-7777-7777-777777777777', 200, 75000.00, 'pending', 1, '11111111-1111-1111-1111-111111111111', null, null)
ON CONFLICT (id) DO NOTHING;

-- Insert sample expenses with valid UUIDs
INSERT INTO expenses (id, category, description, amount, expense_date, created_by)
VALUES 
    ('cccccccc-1111-1111-1111-111111111111', 'Materials', 'Paper stock purchase - A4 sheets', 25000.00, '2024-12-10', '11111111-1111-1111-1111-111111111111'),
    ('cccccccc-2222-2222-2222-222222222222', 'Materials', 'Ink cartridges for digital press', 15000.00, '2024-12-12', '11111111-1111-1111-1111-111111111111'),
    ('cccccccc-3333-3333-3333-333333333333', 'Utilities', 'Monthly electricity bill', 8000.00, '2024-12-05', '11111111-1111-1111-1111-111111111111'),
    ('cccccccc-4444-4444-4444-444444444444', 'Maintenance', 'Offset press service', 12000.00, '2024-12-08', '11111111-1111-1111-1111-111111111111'),
    ('cccccccc-5555-5555-5555-555555555555', 'Materials', 'Binding materials purchase', 8500.00, '2024-12-14', '11111111-1111-1111-1111-111111111111')
ON CONFLICT (id) DO NOTHING; 