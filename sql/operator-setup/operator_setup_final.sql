-- =====================================================
-- GANPATHI OVERSEAS - OPERATOR DATABASE SETUP (FINAL)
-- Works with current database state
-- Run this SQL in Supabase SQL Editor
-- =====================================================

-- Check what we're working with first
SELECT 'Starting operator database setup (final version)...' as status;
...
-- Insert demo users into users table (only columns that definitely exist)
INSERT INTO users (id, name, full_name, email, role, phone) VALUES
('11111111-1111-1111-1111-111111111111', 'Rajesh Kumar', 'Rajesh Kumar', 'admin@ganpathioverseas.com', 'admin', '+91 98765 43210'),
('22222222-2222-2222-2222-222222222222', 'Priya Sharma', 'Priya Sharma', 'supervisor@ganpathioverseas.com', 'supervisor', '+91 98765 43211'),
('33333333-3333-3333-3333-333333333333', 'Amit Patel', 'Amit Patel', 'finance@ganpathioverseas.com', 'finance', '+91 98765 43212'),
('44444444-4444-4444-4444-444444444444', 'Suresh Yadav', 'Suresh Yadav', 'operator1@ganpathioverseas.com', 'operator', '+91 98765 43213'),
('55555555-5555-5555-5555-555555555555', 'Deepak Singh', 'Deepak Singh', 'operator2@ganpathioverseas.com', 'operator', '+91 98765 43214')
...
-- Update users with additional fields if columns exist
DO $$ BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'users' AND column_name = 'username') THEN
        UPDATE users SET username = 'admin' WHERE id = '11111111-1111-1111-1111-111111111111';
        UPDATE users SET username = 'supervisor' WHERE id = '22222222-2222-2222-2222-222222222222';
        UPDATE users SET username = 'finance' WHERE id = '33333333-3333-3333-3333-333333333333';
        UPDATE users SET username = 'operator1' WHERE id = '44444444-4444-4444-4444-444444444444';
        UPDATE users SET username = 'operator2' WHERE id = '55555555-5555-5555-5555-555555555555';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'users' AND column_name = 'address') THEN
        UPDATE users SET address = 'Mumbai, Maharashtra' WHERE id IN (
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'users' AND column_name = 'salary') THEN
        UPDATE users SET salary = 80000 WHERE id = '11111111-1111-1111-1111-111111111111';
        UPDATE users SET salary = 60000 WHERE id = '22222222-2222-2222-2222-222222222222';
        UPDATE users SET salary = 55000 WHERE id = '33333333-3333-3333-3333-333333333333';
        UPDATE users SET salary = 35000 WHERE id = '44444444-4444-4444-4444-444444444444';
        UPDATE users SET salary = 38000 WHERE id = '55555555-5555-5555-5555-555555555555';
    END IF;
END $$;
